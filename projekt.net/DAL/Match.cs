...
namespace DAL
{
      ...
      /* public partial class Match
        {
            public static List<Match> FromJson(string json) => JsonConvert.DeserializeObject<List<Match>>(json, DAL.Converter.Settings);
        }

        public static class Serialize
        {
            public static string ToJson(this List<Match> self) => JsonConvert.SerializeObject(self, DAL.Converter.Settings);
        }
